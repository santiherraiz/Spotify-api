 ...
 */
class Artista extends \App\Entity\Artista implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Artista' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Artista' . "\0" . 'nombre', '' . "\0" . 'App\\Entity\\Artista' . "\0" . 'imagen', '' . "\0" . 'App\\Entity\\Artista' . "\0" . 'usuario'];
        }
